...
from functions import welcome, teams_list, player_stats, print_stats
    ...
    for team in teams:
        ...
        if status_code == 200:
            ...
            if not searched_players_stats:
                ...
                print(searched_players_stats)

        else:
            print('Error') # tira error 429 == too many requests, solo llega hasta el team id 4, es decir que solo llega a hacer el get a 3 equipos
            print(team)
            print(status_code)
